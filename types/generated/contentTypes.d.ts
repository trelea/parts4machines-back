...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    mark: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    engine_capacity: Schema.Attribute.Integer;
    horse_power: Schema.Attribute.Integer;
    ...
    fuel: Schema.Attribute.Relation<'manyToOne', 'api::fuel.fuel'>;
    traction: Schema.Attribute.Relation<'manyToOne', 'api::traction.traction'>;
    wheel: Schema.Attribute.Relation<'manyToOne', 'api::wheel.wheel'>;
...
export interface ApiFuelFuel extends Struct.CollectionTypeSchema {
...
export interface ApiTractionTraction extends Struct.CollectionTypeSchema {
  collectionName: 'tractions';
  info: {
    singularName: 'traction';
    pluralName: 'tractions';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::traction.traction': ApiTractionTraction;
